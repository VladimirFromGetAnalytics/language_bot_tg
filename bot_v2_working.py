...
# Start command handler - ИСПРАВЛЕНО
...
# OpenAI functions - ИСПРАВЛЕНО для нового API
async def generate_first_question(level, topic):
    ...
    try:
        ...
        return f"Let's talk about {topic}. Can you tell me what you think about this topic?"
